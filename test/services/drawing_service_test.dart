...
void main() {
  ...
  group('DrawingService', () {
    ...
    // -----------------------------------------------------------------------
    // Option B: Reference unit coordinates (no renderData at pen-up)
    // -----------------------------------------------------------------------
    group('pen-up produces world-coordinate points (no renderData)', () {
      test('pen-up preserves raw points in world coordinates', () {
        service.onPointerDown(
          strokeId: 'raw-1',
          pageId: 'page-1',
        ...
        // Raw points should still be in world coordinates
      ...
      test('pen-up does not generate renderData', () {
        service.onPointerDown(
          strokeId: 'no-rd-1',
          pageId: 'page-1',
          point: makePoint(500.0, 250.0, timestamp: 0),
        ...
        final committed = service.onPointerUp();
        expect(committed, isNotNull);
        expect(committed!.renderData, isNull);
      });

      test('renderPoints getter returns raw points', () {
        service.onPointerDown(
          strokeId: 'bridge-1',
          pageId: 'page-1',
          point: makePoint(500.0, 250.0, timestamp: 0),
